...
class Solution {
    public boolean isBridge(int V, int[][] edges, int c, int d) {
        ...
        // Step 2: Remove the edge c-d temporarily
        adj.get(c).remove(Integer.valueOf(d));
        adj.get(d).remove(Integer.valueOf(c));

        // Step 3: Check if d is reachable from c using DFS
        boolean[] visited = new boolean[V];
        dfs(c, adj, visited);

        // Step 4: If d is not visited after DFS, it means the edge was a bridge
        return !visited[d];
    }
